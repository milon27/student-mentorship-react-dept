...
export default function QuestionsModal({ show, setShow,question_item }) {
  const { appDispatch, question_listDispatch } = useContext(DispatchContext);

  const initQuestion = {
    sub_skill_id:question_item.id,
    title: "",
    op_1:"",
    op_2:"",
    op_3:"",
  ...
  const onSubmit = async () => {
    ...
    const res = await listAction.addData("career/create/question", Questions);
